...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func checkFavorites(){
        ...
        NSUserDefaults.standardUserDefaults().setObject(array, forKey: "packages")
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("TrakieModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Trakie.sqlite")
